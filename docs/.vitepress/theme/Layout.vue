...
const CarbonAds = __CARBON__
  ? defineAsyncComponent(() => import('vitepress/dist/client/theme-default/components/CarbonAds.vue'))
  : NoopComponent
const BuySellAds = __BSA__
  ? defineAsyncComponent(() => import('vitepress/dist/client/theme-default/components/BuySellAds.vue'))
  : NoopComponent
