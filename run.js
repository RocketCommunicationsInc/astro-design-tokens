...
exec('node_modules/.bin/token-transformer data/tokens.json tokens/base.component.json reference,system,components,input,button reference,system --expandTypography --preserveRawValue')
