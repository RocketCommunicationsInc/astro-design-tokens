...
rgba([UIColor colorWithRed:1.000f green:1.000f blue:1.000f alpha:1.000f], .6),
...
rgba([UIColor colorWithRed:0.573f green:0.796f blue:1.000f alpha:1.000f], .3),
rgba([UIColor colorWithRed:0.110f green:0.247f blue:0.369f alpha:1.000f], .3),
rgba([UIColor colorWithRed:0.000f green:0.000f blue:0.000f alpha:1.000f], 0.50),
linear-gradient(90deg, rgba([UIColor colorWithRed:0.000f green:0.000f blue:0.000f alpha:1.000f], .42) 0%, rgba([UIColor colorWithRed:0.153f green:0.251f blue:0.349f alpha:1.000f], 0) 100%),
rgba([UIColor colorWithRed:0.000f green:0.000f blue:0.000f alpha:1.000f], .25),
rgba([UIColor colorWithRed:0.000f green:0.000f blue:0.000f alpha:1.000f], .12),
rgba([UIColor colorWithRed:0.000f green:0.000f blue:0.000f alpha:1.000f], .20),
rgba([UIColor colorWithRed:0.031f green:0.047f blue:0.067f alpha:1.000f], .30),
[UIColor colorWithRed:1.000f green:1.000f blue:1.000f alpha:1.000f],
...
rgba([UIColor colorWithRed:0.620f green:0.655f blue:0.678f alpha:1.000f], 0),
rgba([UIColor colorWithRed:0.000f green:0.000f blue:0.000f alpha:1.000f], 0),
...
rgba([UIColor colorWithRed:0.176f green:0.800f blue:1.000f alpha:1.000f], 0),
...
rgba([UIColor colorWithRed:0.161f green:0.165f blue:0.176f alpha:1.000f], .60),
[UIColor colorWithRed:1.000f green:1.000f blue:1.000f alpha:1.000f],
...
rgba([UIColor colorWithRed:0.000f green:0.282f blue:0.447f alpha:1.000f], .30),
rgba([UIColor colorWithRed:0.808f green:0.914f blue:0.988f alpha:1.000f], .30),
rgba([UIColor colorWithRed:0.510f green:0.506f blue:0.506f alpha:1.000f], .50),
linear-gradient(90deg, rgba([UIColor colorWithRed:0.000f green:0.000f blue:0.000f alpha:1.000f], 42) 0%, rgba([UIColor colorWithRed:0.153f green:0.251f blue:0.349f alpha:1.000f], 0) 100%),
rgba([UIColor colorWithRed:0.000f green:0.000f blue:0.000f alpha:1.000f], .14),
rgba([UIColor colorWithRed:0.000f green:0.000f blue:0.000f alpha:1.000f], .12),
rgba([UIColor colorWithRed:0.000f green:0.000f blue:0.000f alpha:1.000f], .20),
rgba([UIColor colorWithRed:0.031f green:0.047f blue:0.067f alpha:1.000f], .30),
[UIColor colorWithRed:1.000f green:1.000f blue:1.000f alpha:1.000f],
